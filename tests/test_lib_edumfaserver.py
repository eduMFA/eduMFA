...
class eduMFAServerTestCase(MyTestCase):
    ...
    def test_02_updateserver(self):
        r = add_edumfaserver(identifier="myserver", url="https://pi/pi", tls=False)
        self.assertTrue(r > 0)
    ...
    def test_04_edumfa_request(self):
        responses.add(
            responses.POST,
            "https://edumfa/pi/validate/check",
            body="""{
            "jsonrpc": "2.0",
        ...
        responses.add(
            responses.POST,
            "https://edumfa/pi2/validate/check",
            body="""{
        "jsonrpc": "2.0",
        "signature": "",
        "detail": null,
        ...
        responses.add(
            responses.POST,
            "https://edumfa/pi3/validate/check",
            body="""{
                "jsonrpc": "2.0",
                "signature": "",
                "detail": null,
        ...
        r = add_edumfaserver(identifier="pi3", url="https://edumfa/pi3", tls=False)
        self.assertTrue(r > 0)
        ...
        responses.add(
            responses.POST,
            "https://edumfa/pi4/validate/check",
            body="""{
            "detail": null,
            "result": {
              "status": true,
