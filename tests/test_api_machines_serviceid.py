...
class APIMachinesServiceIDTestCase(MyApiTestCase):
    ...
    def test_03_get_service_ids(self):
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID1}",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}&serial={self.serial1}",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}&application=ssh",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}&application=openssh",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
    ...
    def test_04_get_service_id_for_different_users(self):
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}&application=ssh&user=root",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
        ...
        with self.app.test_request_context(
            f"/machine/token?service_id={self.serviceID2}&application=ssh&user=admin",
            method="GET",
            headers={"Authorization": self.at},
        ):
            res = self.app.full_dispatch_request()
