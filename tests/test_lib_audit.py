...
class AuditTestCase(MyTestCase):
    ...
    def test_06_truncate_data(self):
        ...
        self.assertEqual(
            "Berlin,Hamburg,München,Köln,Frankfu+,Stuttga+,Düsseld+,Dortmund,Essen,Leipzig,Bremen,Dresden,Hannover,Nürnberg,Duisburg,Bochum,Wuppert+,Bielefe+,Bonn,Münster,Karlsru+,Mannheim,Augsburg,Wiesbaden,Gelsenki+,Möncheng+,Braunsch+,Kiel,Chemnitz,Aachen,Magdeburg",
...
class ContainerAuditTestCase(OverrideConfigTestCase):
    ...
    def test_10_container_audit(self):
        ...
        a = ContainerAudit(
            {
                "EDUMFA_AUDIT_CONTAINER_WRITE": ["edumfa.lib.auditmodules.loggeraudit"],
