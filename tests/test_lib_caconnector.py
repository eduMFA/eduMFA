...
class LocalCATestCase(MyTestCase):
    ...
    def setUpClass(cls):
        ...
        shutil.copyfile(f"{WORKINGDIR!s}/serial", f"{WORKINGDIR!s}/serial.orig")
        shutil.copyfile(f"{WORKINGDIR!s}/index.txt", f"{WORKINGDIR!s}/index.txt.orig")
    ...
    def tearDownClass(cls):
        ...
        FILES = [
            "DE_Bavaria_eduMFA_requester.localdomain.req",
        ...
        shutil.copyfile(f"{WORKINGDIR!s}/serial.orig", f"{WORKINGDIR!s}/serial")
        shutil.copyfile(f"{WORKINGDIR!s}/index.txt.orig", f"{WORKINGDIR!s}/index.txt")
