...
class eduMFAServerTestCase(MyApiTestCase):
    """
    test the api.edumfaserver endpoints
    """
    ...
    def test_01_create_server(self):
        ...
        # Unauthorized
        with self.app.test_request_context('/edumfaserver/server1',
                                           method='POST',
        ...
        # list servers
        with self.app.test_request_context('/edumfaserver/',
                                           method='GET',
                                           headers={'Authorization': self.at}):
            res = self.app.full_dispatch_request()
            self.assertTrue(res.status_code == 200, res)
    ...
    def test_02_test_conncection(self):
        ...
        with self.app.test_request_context('/edumfaserver/test_request',
                                           method='POST',
                                           data={
                                               "identifier": "server1",
                                               "tls": "0",
