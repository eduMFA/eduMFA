...
def downgrade():
    print(" * Replacing login_mode=eduMFA with login_mode=privacyIDEA")
    bind = op.get_bind()
    session = orm.Session(bind=bind)
    ...
    print(" * Replacing edumfaserver_read and edumfaserver_write policies ")
    session = orm.Session(bind=bind)
    ...
    print(" * Renaming column edumfanode to pinode")
    op.alter_column(
        "policy",
        "edumfanode",
    ...
    print(" * Renaming table mfa_audit to pidea_audit")
    op.rename_table("mfa_audit", "pidea_audit")

    print(" * Renaming column edumfa_server to privacyidea_server")
    op.alter_column(
        "pidea_audit",
        "edumfa_server",
