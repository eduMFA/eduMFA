# Build stage
FROM python:3.14.0-slim-trixie@sha256:9dc4ef3e628432af2237d1418908f5c6d4528e9f776aaa6e7c95c18854c86e48 AS builder
WORKDIR /tmp
COPY . .
