...
sys.path.insert(0, os.path.abspath('../edumfa'))
...
project = u'edumfa'
copyright = u'2014-2023, Cornelius Kölbel; 2024 eduMFA Project'
...
# pixels large.
html_favicon = "_static/edumfa-icon.png"
...
latex_documents = [
  ('index', 'eduMFA.tex', u'eduMFA Authentication System',
   u'eduMFA', 'manual'),
]
...
man_pages = [
    ('index', 'edumfa-server', u'eduMFA Authentication System',
     [u'eduMFA'], 1)
]
...
texinfo_documents = [
  ('index', 'eduMFA', u'eduMFA AUthentication System',
   u'eduMFA', 'eduMFA', 'One line description of project.',
   'Miscellaneous'),
]
