...
at `edumfa.readthedocs.io <https://edumfa.readthedocs.io/en/latest/installation/index.html>`_.

If you want to setup a development environment, you need to have `UV <https://docs.astral.sh/uv/getting-started/installation/>`_ installed. Then you can run::
