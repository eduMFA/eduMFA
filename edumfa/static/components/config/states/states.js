...
angular.module('eduMfaApp.configStates', ['ui.router', 'eduMfaApp.versioning']).config(
...
//                })
                ...
                .state('config.edumfaserver.list', {
                    url: "/list",
                    templateUrl: configpath + "config.edumfaserver.list.html" + versioningSuffixProviderProvider.$get().$get(),
                    controller: "eduMfaServerController"
                })
                .state('config.edumfaserver.edit', {
                    url: "/edit/:identifier",
                    templateUrl: configpath + "config.edumfaserver.edit.html" + versioningSuffixProviderProvider.$get().$get(),
                    controller: "eduMfaServerController"
                })
