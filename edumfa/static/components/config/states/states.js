 ...
 *
 * 2015 - 2016-05-07 Cornelius Kölbel <cornelius@privacyidea.org>
 *
...
angular
  .module("eduMfaApp.configStates", ["ui.router", "eduMfaApp.versioning"])
  .config([
    "$stateProvider",
    ...
    function ($stateProvider, versioningSuffixProviderProvider) {
      ...
      $stateProvider
        ...
        .state("config.caconnectors.addlocal", {
          ...
          templateUrl:
            configpath +
            "config.caconnectors.local.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "CAConnectorController",
        })
        ...
        .state("config.caconnectors.addmicrosoft", {
          ...
          templateUrl:
            configpath +
            "config.caconnectors.microsoft.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "CAConnectorController",
        })
        ...
        .state("config.edumfaserver", {
          url: "/edumfaserver",
          templateUrl:
            configpath +
            "config.system.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "eduMfaServerController",
        })
        .state("config.edumfaserver.list", {
          url: "/list",
          templateUrl:
            configpath +
            "config.edumfaserver.list.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "eduMfaServerController",
        })
        .state("config.edumfaserver.edit", {
          url: "/edit/:identifier",
          templateUrl:
            configpath +
            "config.edumfaserver.edit.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "eduMfaServerController",
        })
        .state("config.edumfaserver.add", {
          url: "/edit/",
          templateUrl:
            configpath +
            "config.edumfaserver.edit.html" +
        ...
        .state("config.periodictasks.list", {
          ...
          templateUrl:
            configpath +
            "config.periodictasks.list.html" +
            versioningSuffixProviderProvider.$get().$get(),
          controller: "periodicTaskController",
        })
        .state("config.periodictasks.details", {
          ...
          templateUrl:
            configpath +
            "config.periodictasks.details.html" +
            versioningSuffixProviderProvider.$get().$get(),
