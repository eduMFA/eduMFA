 ...
 *
 */
myApp.factory("PolicyTemplateFactory", [
  "$http",
  "inform",
  "gettextCatalog",
  function ($http, inform, gettextCatalog) {
    ...
    return {
      ...
      getTemplates: function (callback) {
        ...
        $http.get(URL + "index.json").then(
          ...
          function (error) {
            ...
            inform.add(
              gettextCatalog.getString("Error fetching" + " policy templates."),
      ...
      getTemplate: function (templateName, callback) {
        ...
        $http.get(URL + templateName + ".json").then(
          function (response) {
            callback(response.data);
          },
          function (error) {
            //debug: console.log(error);
            inform.add(
              gettextCatalog.getString("Error fetching" + " policy template ") +
                templateName,
              { type: "danger", ttl: 10000 },
            );
          },
  ...
  function (
    ...
    return {
      ...
      setSMSGateway: function (params, callback) {
        $http
          .post(smsgatewayUrl, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
      ...
      getHandlerActions: function (handlername, callback) {
        $http
          .get(eventUrl + "/actions/" + handlername, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getHandlerConditions: function (handlername, callback) {
        $http
          .get(eventUrl + "/conditions/" + handlername, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getHandlerPositions: function (handlername, callback) {
        $http
          .get(eventUrl + "/positions/" + handlername, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      delPeriodicTask: function (ptaskid, callback) {
        $http
          .delete(periodicTaskUrl + "/" + ptaskid, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getPeriodicTaskmodules: function (callback) {
        $http
          .get(periodicTaskUrl + "/taskmodules/", {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getPeriodicTaskmoduleOptions: function (taskmodule, callback) {
        $http
          .get(periodicTaskUrl + "/options/" + taskmodule, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      enablePeriodicTask: function (ptaskid, callback) {
        $http
          .post(
            periodicTaskUrl + "/enable/" + ptaskid,
            {},
            { headers: { Authorization: AuthFactory.getAuthToken() } },
          )
          .then(
      ...
      disablePeriodicTask: function (ptaskid, callback) {
        $http
          .post(
            periodicTaskUrl + "/disable/" + ptaskid,
            {},
            { headers: { Authorization: AuthFactory.getAuthToken() } },
          )
          .then(
      ...
      setPolicy: function (policyName, params, callback) {
        $http
          .post(policyUrl + "/" + policyName, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      getEduMfaNodes: function (callback) {
        // Return the definitions for policy conditions
        $http
          .get(policyUrl + "/defs/edumfanodes", {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getMachineResolver: function (resolvername, callback) {
        $http
          .get(machineResolverUrl + "/" + resolvername, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getCAConnectorNames: function (callback) {
        $http
          .get(systemUrl + "/names/caconnector", {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      getCAConnector: function (connectorname, callback) {
        $http
          .get(CAConnectorUrl + "/" + connectorname, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      setMachineResolver: function (name, params, callback) {
        $http
          .post(machineResolverUrl + "/" + name, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      setCAConnector: function (name, params, callback) {
        $http
          .post(CAConnectorUrl + "/" + name, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      getCASpecificOptions: function (catype, params, callback) {
        ...
        $http
          .get(CAConnectorUrl + "/specific/" + catype + "?" + pstring, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      testMachineResolver: function (params, callback) {
        $http
          .post(machineResolverUrl + "/test", params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      delMachineResolver: function (name, callback) {
        $http
          .delete(machineResolverUrl + "/" + name, {
            headers: { Authorization: AuthFactory.getAuthToken() },
          })
          .then(
            function (response) {
      ...
      saveSystemConfig: function (params, callback) {
        $http
          .post(systemUrl + "/setConfig", params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      getRandom: function (len, encode, callback) {
        $http
          .get(
            systemUrl + encodeURI("/random?len=" + len + "&encode=" + encode),
            {
              headers: {
                Authorization: AuthFactory.getAuthToken(),
                "Content-Type": "application/json",
      ...
      testTokenConfig: function (tokentype, params, callback) {
        $http
          .post(systemUrl + "/test/" + tokentype, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      delSmtp: function (identifier, callback) {
        $http
          .delete(smtpServerUrl + "/" + identifier, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      addSmtp: function (params, callback) {
        ...
        $http
          .post(smtpServerUrl + "/" + identifier, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      testSmtp: function (params, callback) {
        $http
          .post(smtpServerUrl + "/send_test_email", params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      getRadius: function (callback, identifier) {
        ...
        $http
          .get(radiusServerUrl + "/" + identifier, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      delRadius: function (identifier, callback) {
        $http
          .delete(radiusServerUrl + "/" + identifier, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      addRadius: function (params, callback) {
        var identifier = params["identifier"];
        $http
          .post(radiusServerUrl + "/" + identifier, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      testRadius: function (params, callback) {
        $http
          .post(radiusServerUrl + "/test_request", params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      addTokengroup: function (params, callback) {
        $http
          .post(tokengroupUrl + "/" + params["groupname"], params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      delTokengroup: function (groupname, callback) {
        $http
          .delete(tokengroupUrl + "/" + groupname, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      addServiceid: function (params, callback) {
        $http
          .post(serviceidUrl + "/" + params["servicename"], params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      getEduMfaServer: function (callback, identifier) {
        if (!identifier) {
          identifier = "";
        }
        $http
          .get(eduMfaServerUrl + "/" + identifier, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      delEduMfaServer: function (identifier, callback) {
        $http
          .delete(eduMfaServerUrl + "/" + identifier, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      addEduMfaServer: function (params, callback) {
        var identifier = params["identifier"];
        $http
          .post(eduMfaServerUrl + "/" + identifier, params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
      ...
      testEduMfaServer: function (params, callback) {
        $http
          .post(eduMfaServerUrl + "/test_request", params, {
            headers: {
              Authorization: AuthFactory.getAuthToken(),
              "Content-Type": "application/json",
            },
