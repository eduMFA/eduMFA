 ...
 *
 */
myApp.controller("periodicTaskController", [
  "$scope",
  "$stateParams",
  "$state",
  "$location",
...
myApp.controller("periodicTaskDetailController", [
  "$scope",
  "$stateParams",
  "ConfigFactory",
  "$state",
  function ($scope, $stateParams, ConfigFactory, $state) {
    ...
    $scope.getTaskmoduleOptions = function () {
      ConfigFactory.getPeriodicTaskmoduleOptions(
        $scope.form.taskmodule,
        function (response) {
        ...
        ConfigFactory.getPeriodicTaskmoduleOptions(
          ...
          function (response) {
            ...
            angular.forEach($scope.form.options, function (value, opt) {
              ...
              if (
                $scope.taskmoduleOptions[opt].type === "bool" &&
                isTrue(value)
              ) {
