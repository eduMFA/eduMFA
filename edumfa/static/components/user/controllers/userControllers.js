 ...
 *
 */
angular.module("eduMfaApp").controller("userAddController", [
  "$scope",
  "userUrl",
  "$state",
  "$location",
...
angular.module("eduMfaApp").controller("userPasswordController", [
  "$scope",
  "userUrl",
  "UserFactory",
  "inform",
...
angular.module("eduMfaApp").controller("userDetailsController", [
  "$scope",
  "userUrl",
  "realmUrl",
  "tokenUrl",
  ...
  function (
    ...
    $scope.onCustomAttributeKeyChange = function () {
      ...
      $scope.allowed_values =
        $scope.allowed_custom_attributes["set"][$scope.selected_attr_key];
...
angular.module("eduMfaApp").controller("userController", [
  "$scope",
  "$location",
  "userUrl",
  "realmUrl",
