 ...
 *
 */
angular.module("eduMfaApp").controller("machineDetailsController", [
  "$scope",
  "MachineFactory",
  function ($scope, MachineFactory) {
    ...
    $scope.getMachineTokens = function () {
      MachineFactory.getMachineTokens(
        { machineid: $scope.machineid, resolver: $scope.machineresolver },
        function (data) {
    ...
    $scope.detachMachineToken = function (serial, application, mtid) {
      MachineFactory.detachTokenMachine(
        { serial: serial, application: application, mtid: mtid },
        function (data) {
          $scope.getMachineTokens();
        },
      );
