...
myApp.constant(
  "machineResolverUrl",
  backendUrl + instance + "/machineresolver",
);
...
myApp.config([
  "$httpProvider",
  function ($httpProvider, inform, gettext) {
...
myApp.config([
  ...
  function ($compileProvider) {
    ...
    let url_re =
      /^\s*(https:\/\/(edumfa\.readthedocs\.io|docs\.edumfa\.io)\/|otpauth:|mailto:|file:|blob:)/;
