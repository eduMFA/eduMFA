...
def get_resolvers(resolver=None):
    ...
    You can run a POST request to update the data and eduMFA will ignore the "__CENSORED__"
...
def test_resolver():
    """
    Send the complete parameters of a resolver to the eduMFA server
    ...
    password. eduMFA will use the already stored password from the
    database.
