...
#
# 2020 Jean-Pierre Höhmann <jean-pierre.hohemann@netknights.it>
 ...
 * :func:`edumfa.lib.token.check_user_pass`
 * :func:`edumfa.lib.token.check_token_list`
 * :func:`edumfa.lib.tokenclass.TokenClass.authenticate`
 * :func:`edumfa.lib.tokenclass.TokenClass.check_pin`
 * :func:`edumfa.lib.tokenclass.TokenClass.check_otp`

In case if authenticating a serial number:

 * :func:`edumfa.lib.token.check_serial_pass`
 * :func:`edumfa.lib.token.check_token_list`
 * :func:`edumfa.lib.tokenclass.TokenClass.authenticate`
 * :func:`edumfa.lib.tokenclass.TokenClass.check_pin`
 * :func:`edumfa.lib.tokenclass.TokenClass.check_otp`
...
def trigger_challenge():
    ...
    eduMFA will trigger challenges for all native challenges response
    tokens, possessed by this user or only for the given serial number.

    The request needs to contain a valid Authorization header.
        ...
        g.audit_object.log(
            {
                ...
                "info": log_used_user(user, f"triggered {result_obj} challenges"),
