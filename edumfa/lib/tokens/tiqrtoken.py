...
the otpkey is generated on the smartphone and pushed to the eduMFA
...
An application that wants to use the TiQR token with eduMFA has to use
...
4. The TiQR App communicates with eduMFA via the API /ttype/tiqr. In this
