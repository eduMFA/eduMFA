...
def reset_all_user_tokens_passkey(user):
    ...
    if reset_all:
        ...
        tokens = [
            tok for tok in tokens if tok.get_class_type() not in ["registration"]
        ]
            ...
            if registration_client_extensions:
                try:
                    ...
                    if "credProps" in extensions:
                        ...
                        resident_key = "rk" in credProps and (
                            credProps["rk"] or credProps["rk"] == "true"
                        )
                        if resident_key:
