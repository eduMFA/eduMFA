        ...
        actions = {
            ...
            "savefile": {
                ...
                "filename": {
                    ...
                    "required": True,
                    "description": _(
                        "The filename of the notification. Existing files are overwritten. The name can contain tags as specified in the documentation and can also contain the tag"
                        " {random}."
                    ),
                },
            },
        ...
        if recipient or action.lower() == "savefile":
            ...
            if action.lower() == "sendmail":
                ...
                spooldir = get_app_config_value(
                    "EDUMFA_NOTIFICATION_HANDLER_SPOOLDIRECTORY",
