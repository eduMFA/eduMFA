...
#
"""
These are the applications that can be assigned to machines in eduMFA.
...
from .base import get_application_types, get_auth_item, is_application_allow_bulk_call
