...
def export_event(name=None):
    ...
    # handler is created each time. Users that *do* want the ID in the output,
    # can either just add it themselves or use one of the other commands (e.g.
    # `edumfa-manage event export/p_export`,
    # `edumfa-manage config export event`). `edumfa-manage exporter -t event`
