...
from edumfa.lib.config import (get_token_class, get_token_prefix,
...
from edumfa.lib.policydecorators import (libpolicy,
...
from edumfa.lib.challengeresponsedecorators import (generic_challenge_response_reset_pin,
        ...
        for tokenobject in challenge_response_token_list:
            if tokenobject.check_challenge_response(passw=passw,
                ...
                if not tokenobject.is_fit_for_challenge(messages, options=options):
                    ...
                    log.info("Received a valid response to a challenge for a non-fit token {0!s}. {1!s}".format(tokenobject.token.serial,
                                                                                 reply_dict["message"]))
                else:
